...
goto pr)else if [!om!]==[-version] (@echo 1.8.0.17264+f4deb0e  %__dxp_pv%&goto pu)else if [!om!]==[-build-info] (set ob=1&goto pw)else if [!om!]==[-tests] (set /a "ol+=1" & call :px pp[!ol!] v
